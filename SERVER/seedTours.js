...
const CATEGORIES = [
  {
    ...
    description: "Khám phá thiên nhiên hoang sơ, rừng núi, suối thác",
  },
  {
    name: "Du lịch văn hoá",
    description: "Trải nghiệm văn hoá dân tộc, lễ hội, làng nghề",
  },
  {
    name: "Du lịch mạo hiểm",
    description: "Leo núi, trekking, cắm trại, thể thao mạo hiểm",
  },
  {
    name: "Du lịch nghỉ dưỡng",
    description: "Nghỉ ngơi tại resort, homestay cao cấp",
  },
  {
    name: "Du lịch ẩm thực",
    description: "Khám phá ẩm thực vùng miền, chợ phiên",
  },
  {
    name: "Du lịch tâm linh",
    description: "Tham quan chùa chiền, đền miếu, di tích tâm linh",
  },
];
    ...
    [
      {
        ...
        content:
          "Xuất phát từ điểm hẹn, di chuyển đến điểm đến. Nhận phòng khách sạn, tham quan trung tâm thị trấn, chợ phiên và các điểm văn hoá nổi bật. Ăn tối với đặc sản địa phương.",
        image: "",
      },
      {
        day: "Ngày 2",
        ...
        content:
          "Ăn sáng tại khách sạn, tham quan các bản làng dân tộc, trải nghiệm đời sống bản địa. Ăn trưa và trả phòng, khởi hành về lại điểm xuất phát.",
        image: "",
      },
    ],
    [
      {
        ...
        meals: "Ăn trưa, Ăn tối",
        content:
          "Khởi hành sáng sớm, đến nơi vào buổi trưa. Check-in homestay, đi bộ khám phá bản làng, ngắm ruộng bậc thang. Tối tham gia đốt lửa trại cùng người dân bản địa.",
        image: "",
      },
      {
        day: "Ngày 2",
        meals: "Ăn sáng, Ăn trưa",
        content:
          "Dậy sớm ngắm bình minh. Trek nhẹ qua các cung đường ruộng bậc thang. Thưởng thức bữa trưa đặc sản rồi trở về.",
        image: "",
      },
    ],
  ],
    ...
    [
      {
        ...
        meals: "Ăn trưa, Ăn tối",
        content:
          "Di chuyển từ Hà Nội, dừng chân nghỉ ngơi dọc đường, đến nơi vào buổi chiều. Nhận phòng và tản bộ ngắm cảnh hoàng hôn. Ăn tối với lẩu cá hồi tươi.",
        image: "",
      },
      {
        day: "Ngày 2",
        ...
        content:
          "Tham quan thác nước hùng vĩ, trekking qua rừng nguyên sinh, ghé thăm bản người Mông. Chiều tham gia workshop nhuộm chàm truyền thống. Tối thưởng thức BBQ tại homestay.",
        image: "",
      },
      {
        day: "Ngày 3",
        meals: "Ăn sáng, Ăn trưa",
        content:
          "Tham quan chợ phiên buổi sáng, mua quà lưu niệm thủ công mỹ nghệ. Ăn trưa rồi khởi hành trở về Hà Nội, dự kiến đến nơi vào tối.",
        image: "",
      },
    ],
    [
      {
        ...
        meals: "Ăn trưa, Ăn tối",
        content:
          "Xuất phát sáng sớm, đi qua đèo với cảnh quan hùng vĩ. Dừng chân chụp ảnh tại các điểm view đẹp nhất. Đến khách sạn, tự do khám phá khu vực lân cận.",
        image: "",
      },
      {
        day: "Ngày 2",
        meals: "Ăn sáng, Ăn trưa, Ăn tối",
        content:
          "Ngày dành trọn cho trekking: chinh phục đỉnh núi, qua suối, ghé hang động. Picnic giữa rừng. Chiều về homestay nghỉ ngơi, tắm lá thuốc người Dao.",
        image: "",
      },
      {
        day: "Ngày 3",
        meals: "Ăn sáng, Ăn trưa",
        content:
          "Buổi sáng tham quan vườn hoa, đồi chè. Mua đặc sản địa phương làm quà. Ăn trưa và trả phòng, lên xe về lại thành phố.",
        image: "",
      },
    ],
  ],
    ...
    [
      {
        ...
        meals: "Ăn trưa, Ăn tối",
        content:
          "Xuất phát từ thành phố, vượt đèo ngắm cảnh hùng vĩ. Đến nơi check-in resort 4 sao, thư giãn spa buổi chiều. Ăn tối buffet đặc sản vùng cao.",
        image: "",
      },
      {
        day: "Ngày 2",
        meals: "Ăn sáng, Ăn trưa, Ăn tối",
        content:
          "Tham quan quần thể danh thắng, di tích lịch sử. Ăn trưa tại nhà hàng view núi. Chiều thăm bản làng người Thái, học dệt thổ cẩm.",
        image: "",
      },
      {
        day: "Ngày 3",
        meals: "Ăn sáng, Ăn trưa, Ăn tối",
        content:
          "Ngày mạo hiểm: chèo thuyền kayak trên hồ, đạp xe xuyên rừng, leo vách đá. Tối BBQ và chương trình văn nghệ dân gian.",
        image: "",
      },
      {
        day: "Ngày 4",
        meals: "Ăn sáng, Ăn trưa",
        content:
          "Ngủ nướng, ăn sáng thong thả. Ghé chợ phiên sắm quà đặc sản. Trưa lên xe trở về, dừng nghỉ dọc đường tại quán cà phê view đèo.",
        image: "",
      },
    ],
  ],
    ...
    [
      {
        ...
        meals: "Ăn trưa, Ăn tối",
        content:
          "Bay từ TP.HCM ra Hà Nội, xe đón đưa lên vùng cao. Nhận phòng khách sạn, dạo phố cổ buổi tối, thưởng thức phở nóng.",
        image: "",
      },
      {
        day: "Ngày 2",
        meals: "Ăn sáng, Ăn trưa, Ăn tối",
        content:
          "Tham quan đỉnh Fansipan bằng cáp treo, chiêm ngưỡng biển mây. Chiều xuống thung lũng Mường Hoa ngắm ruộng bậc thang. Tối ăn lẩu thả tại nhà hàng ven suối.",
        image: "",
      },
      {
        day: "Ngày 3",
        meals: "Ăn sáng, Ăn trưa, Ăn tối",
        content:
          "Di chuyển qua các bản Tả Van, Tả Phìn. Trải nghiệm tắm lá thuốc người Dao Đỏ. Học nấu món thắng cố truyền thống. Đêm xem biểu diễn khèn Mông.",
        image: "",
      },
      {
        day: "Ngày 4",
        meals: "Ăn sáng, Ăn trưa, Ăn tối",
        content:
          "Trekking cung đường mới qua rừng trúc, qua cầu treo. Picnic bên thác nước. Chiều về homestay làm bánh dày cùng dân bản. Tối tiệc chia tay quanh bếp lửa.",
        image: "",
      },
      {
        day: "Ngày 5",
        meals: "Ăn sáng, Ăn trưa",
        content:
          "Sáng tự do mua sắm tại chợ Sapa. Trưa ăn bún riêu đặc biệt rồi xuống xe về Hà Nội, bay trở lại TP.HCM.",
        image: "",
      },
    ],
  ],
...
function generateDepartures(numDays, tier) {
  ...
  const numDepartures = 4 + Math.floor(Math.random() * 8);
  ...
  for (let i = 0; i < numDepartures; i++) {
    ...
    const priceMultiplier = 0.85 + Math.random() * 0.35;
    const surcharge =
      Math.random() < 0.3
        ? Math.round((Math.random() * 500000) / 50000) * 50000
        : 0;
    ...
    departures.push({
      ...
      adultPrice:
        Math.round((base.adult * priceMultiplier * numDays) / 3 / 50000) *
        50000,
      childPrice:
        Math.round((base.child * priceMultiplier * numDays) / 3 / 50000) *
        50000,
      babyPrice:
        Math.round((base.baby * priceMultiplier * numDays) / 3 / 50000) * 50000,
      surcharge,
      maxslots: maxSlots,
      availableslots:
        maxSlots - Math.floor(Math.random() * Math.min(8, maxSlots)),
    });
  }
  return departures;
}
...
async function seed() {
  try {
    ...
    for (const l of LOCATIONS) {
      const doc = await Location.findOneAndUpdate({ name: l.name }, l, {
        upsert: true,
        new: true,
      });
      locDocs.push(doc);
    ...
    const partnerData = [
      {
        email: "partner1@taybac.com",
        password: "Partner@123",
        fullname: "Công ty Du Lịch Tây Bắc Xanh",
        companyname: "Tây Bắc Xanh Travel",
        taxcode: "0123456789",
        role: "Partner",
        isTrusted: true,
      },
      {
        email: "partner2@taybac.com",
        password: "Partner@123",
        fullname: "Công ty Du Lịch Sao Vàng",
        companyname: "Sao Vàng Tourism",
        taxcode: "9876543210",
        role: "Partner",
        isTrusted: true,
      },
      {
        email: "partner3@taybac.com",
        password: "Partner@123",
        fullname: "Công ty TNHH Mây Núi Adventures",
        companyname: "Mây Núi Adventures",
        taxcode: "1122334455",
        role: "Partner",
        isTrusted: false,
      },
    ...
    for (const loc of locDocs) {
      ...
      for (let t = 0; t < numTours; t++) {
        ...
        const templates =
          ITINERARY_TEMPLATES[dur.days] || ITINERARY_TEMPLATES[3];
        const itinerary = pickRandom(templates);

        const images = [pickRandom(SAMPLE_IMAGES), pickRandom(SAMPLE_IMAGES)];
        const gallery = SAMPLE_IMAGES.sort(() => 0.5 - Math.random()).slice(
          0,
    ...
    await Tour.deleteMany({
      code: { $regex: /^[A-ZÀ-Ỹ]{3}-[A-ZÀ-Ỹ]{3}-\d{3}$/ },
    });
    ...
    const customerNames = [
      ...
      {
        fullname: "Vũ Quang Phú",
        email: "customer6@test.com",
        phone: "0906666666",
        cccd: "001099000006",
      },
      {
        fullname: "Đặng Ngọc Giang",
    ...
    for (let i = 0; i < TOTAL_BOOKINGS_TARGET; i++) {
      ...
      const bookingDate = new Date(2025, 10 + monthOffset, dayInMonth);
      ...
      if (numAdults > 0) {
        tickets.push({
          ...
          quantity: numAdults,
          unitPrice: departure.adultPrice,
        });
      ...
      if (numChildren > 0) {
        tickets.push({
          ...
          unitPrice: departure.childPrice,
        });
      ...
      for (let p = 0; p < numPassengers; p++) {
        ...
        let pType = "Người lớn";
        if (p >= numAdults - 1 && p < numAdults - 1 + numChildren)
          pType = "Trẻ em";
        ...
        passengers.push({
          ...
          cccd_or_birthyear:
            pType === "Người lớn"
              ? `00109900${String(1000 + p).slice(-4)}`
              : `20${10 + Math.floor(Math.random() * 15)}`,
        });
      }
    ...
    const reviewBookings = insertedBookings.filter(
      (b) => b.isReviewed && b.status === "completed",
    );
    const allReviews = [];
    ...
    for (const b of reviewBookings) {
      ...
      allReviews.push({
        ...
        createdAt: new Date(
          +b.createdAt + Math.floor(Math.random() * 7) * 86400000,
        ),
      });
    }
    ...
    const goodBookings = insertedBookings.filter((b) =>
    ...
    console.log(
      `     ├─ Huỷ/Fail : ${insertedBookings.filter((b) => ["cancelled", "payment_failed"].includes(b.status)).length}`,
    );
    console.log(
      `     └─ Pending  : ${insertedBookings.filter((b) => ["pending_payment", "payment_verifying"].includes(b.status)).length}`,
    );
    console.log(`  ⭐ Reviews    : ${allReviews.length}`);
    console.log(
      `  💰 Tổng DT    : ${(totalRevenue / 1000000).toFixed(1)}M VND`,
    );
    console.log("══════════════════════════════════════");
  } catch (err) {
