        ...
        <div className="admin-container">
            <aside className="admin-sidebar">
                <div className="admin-brand">
                    <h2><Link to="/" className="brand-link">Tây Bắc Travel</Link></h2>
                ...
                <nav className="admin-nav">
                    ...
                    <Link to="/admin/bookings" className={location.pathname.includes('/bookings') ? 'active' : ''}>
                        🛍️ Quản lý Đơn hàng
                    </Link>
                    <Link to="/admin/tours" className={location.pathname.includes('/tours') ? 'active' : ''}>
                        🗺️ Quản lý Tour
                    </Link>
                    ...
                    {role === 'Admin' && (
                        <NavLink
                            ...
                            className={({ isActive }) => (isActive || location.pathname.includes('/notifications') ? 'active' : '')}
                        >
            ...
            <main className="admin-main-content">
                <header className="admin-header">
                    <h3>Xin chào, {user?.fullname || (role === 'Admin' ? 'Quản trị viên' : 'Đối tác')}!</h3>
                </header>
