...
export default function PartnerShop() {
  ...
  if (loading)
    return (
      <h2 style={{ textAlign: "center", marginTop: "100px", color: "#2d4271" }}>
        Đang tải gian hàng...
      </h2>
    );
  if (!shopData || !shopData.partner)
    return (
      <h2 style={{ textAlign: "center", marginTop: "100px", color: "#e74c3c" }}>
    ...
    <div className="shopee-shop-wrapper fade-in">
        ...
        <div
          ...
          style={{
            backgroundImage: partner.coverImage
              ? `url(${IMAGE_URL}${partner.coverImage})`
              : "url(https://images.unsplash.com/photo-1506744626753-eda8151a7471?auto=format&fit=crop&w=1200&q=80)",
          }}
        >
          ...
          <div className="shopee-header-content">
            <div className="shopee-header-left">
              <img
                src={
                  partner.avatar && !partner.avatar.includes("default")
                    ? `${IMAGE_URL}${partner.avatar}`
              ...
              <div>
                <h1 className="shopee-shop-name">
                  ...
                  {partner.isTrusted && (
                    <span className="badge-trusted">Uy tín</span>
                  )}
                </h1>
                <p className="shopee-organizer-name">
                  <i className="fa-solid fa-user"></i> Tổ chức bởi:{" "}
                  {partner.fullname}
                </p>
              </div>
            </div>
            <div className="shopee-header-right">
              <div className="shopee-stat-item">
                <span className="stat-label">
                  <i className="fa-solid fa-bag-shopping"></i> Sản phẩm Tour:
                </span>
              ...
              <div className="shopee-stat-item">
                <span className="stat-label">
                  <i className="fa-solid fa-envelope"></i> Tỷ lệ phản hồi:
                </span>
                <span className="stat-value">98%</span>
              </div>
              <div className="shopee-stat-item">
                <span className="stat-label">
                  <i className="fa-solid fa-handshake"></i> Tham gia:
                </span>
      ...
      <div className="shopee-body-container">
        ...
        <div className="shopee-sidebar">
          ...
          <p className="shopee-description">
            {partner.shopDescription ||
              "Đơn vị này chưa cập nhật thông tin giới thiệu. Hệ thống Tây Bắc Travel đảm bảo 100% đối tác đã được xác thực an toàn."}
          </p>
          {partner.shopPolicies && (
            <div className="shopee-policies">
              <h3
                className="shopee-section-title"
                style={{
                  border: "none",
                  padding: 0,
                  marginBottom: "8px",
              ...
              >
                <i className="fa-solid fa-shield-halved"></i> Chính Sách
              </h3>
        ...
        <div className="shopee-main-content">
          <div className="shopee-tours-header">TẤT CẢ SẢN PHẨM TOUR</div>
          {tours.length === 0 ? (
