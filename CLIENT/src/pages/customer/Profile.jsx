...
export default function Profile() {
    ...
    const [profileData, setProfileData] = useState({ fullname: '', phone: '', email: '', cccd: '' });
    ...
    const handleChangePassword = async (e) => {
        ...
        try {
            ...
            Swal.fire('Thất bại', error.response?.data || 'Sai mật khẩu cũ!', 'error');
        }
    };
                ...
                <div className="profile-sidebar" id="test-sidebar">
                    <div className="sidebar-avatar-section">
                        <div className="avatar-wrapper">
                            <img
                                src={avatarPreview ? (avatarPreview.startsWith('blob') ? avatarPreview : `${IMAGE_URL}${avatarPreview}`) : "https://via.placeholder.com/150"}
                                alt="Avatar"
                            />
                        ...
                        <div className="tab-pane fade-in">
                            ...
                            <form onSubmit={handleUpdateProfile} className="profile-form">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="tel" value={profileData.phone} onChange={(e) => setProfileData({ ...profileData, phone: e.target.value })} required />
                                </div>
                                <div className="form-group">
                                    <label>CCCD</label>
                                    <input type="text" value={profileData.cccd} onChange={(e) => setProfileData({ ...profileData, cccd: e.target.value })} />
                                </div>
