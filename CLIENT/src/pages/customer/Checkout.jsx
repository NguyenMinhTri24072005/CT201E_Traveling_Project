    ...
    <div className="checkout-container">
      <div className="checkout-form-section">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="passenger-count-group">
            <div className="passenger-count-item">
              <label className="passenger-label">
                Người lớn ({">="}12t) <br />
                <span className="passenger-price-highlight">
          ...
          <h3 className="checkout-step-title">
            2. THÔNG TIN NGƯỜI ĐẠI DIỆN (Bắt buộc)
          </h3>
          <div className="info-box required">
            <div className="info-grid">
              <div>
                <label className="passenger-label">Họ và Tên *</label>
                <input
                  type="text"
                  name="fullName"
                  required
              ...
              <div>
                <label className="passenger-label">Số CCCD *</label>
                <input
                  type="text"
                  name="cccd"
                  required
              ...
              <div>
                <label className="passenger-label">Số điện thoại *</label>
                <input
                  type="tel"
                  name="phone"
                  required
          ...
          {passengers.length > 0 && (
            <>
              <h3 className="checkout-step-title">
                3. THÔNG TIN NGƯỜI ĐI CÙNG (Không bắt buộc)
              </h3>
              <p className="info-note">
                Bạn có thể bổ sung thông tin hành khách sau khi đặt tour.
              </p>
              {passengers.map((p, index) => (
                <div key={index} className="info-box optional">
                  <strong className="optional-passenger-title">
                    Hành khách {index + 2} ({p.passengerType})
                  </strong>
                  <div className="optional-passenger-grid">
                    ...
                    <div className="optional-passenger-input">
                      <input
                        type="text"
                        placeholder={
                          p.passengerType === "Người lớn"
                            ? "Số CCCD (Tùy chọn)"
                            : "Năm sinh (Tùy chọn)"
                        }
                        value={p.cccd_or_birthyear}
                        onChange={(e) =>
                          handlePassengerChange(
                            index,
                            "cccd_or_birthyear",
          ...
          <div className="payment-method-box">
            ...
            <div>
              <strong className="payment-method-title">
                Chuyển khoản / Quét mã QR (Bắt buộc)
              </strong>
              <p className="payment-method-desc">
                Vui lòng chuẩn bị sẵn ứng dụng ngân hàng. Hệ thống sẽ giữ chỗ
                ngay khi bạn hoàn tất đặt đơn.
              </p>
            </div>
          </div>
      ...
      <div className="checkout-summary-section">
        ...
        <p className="summary-detail">
          <strong>Khởi hành:</strong> {selectedDate.date}
        </p>
        <p className="summary-detail">
        ...
        <div className="summary-calc-box">
          {numAdults > 0 && (
            <div className="summary-calc-row">
              <span>Người lớn x {numAdults}</span>
              <span>{(numAdults * adultPrice).toLocaleString()}₫</span>
            </div>
          )}
          {numChildren > 0 && (
            <div className="summary-calc-row">
              <span>Trẻ em x {numChildren}</span>
              <span>{(numChildren * childPrice).toLocaleString()}₫</span>
            </div>
          )}
          {numInfants > 0 && (
            <div className="summary-calc-row">
              <span>Em bé x {numInfants}</span>
              <span>{(numInfants * infantPrice).toLocaleString()}₫</span>
            </div>
          )}
        ...
        <div className="payment-modal-overlay">
          <div className="payment-modal">
            ...
            <div className="qr-payment-details">
              ...
              <p>
                <strong>Chủ TK:</strong> TAY BAC TRAVEL
              </p>
              <p>
                <strong>Số tiền:</strong>{" "}
                <span className="qr-price-highlight">
                  {totalPrice.toLocaleString()}₫
                </span>
              </p>
              <p>
                <strong>Nội dung:</strong> {formData.phone} DAT TOUR
              </p>
            </div>
            <div className="modal-actions">
              ...
              >
                <i className="fa-solid fa-hourglass-half"></i> GIỮ CHỖ & THANH
                TOÁN SAU
              </button>
              <button
