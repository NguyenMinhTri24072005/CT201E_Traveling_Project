    ...
    <div className="home-page fade-in">
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Hành trình trọn vẹn - Trải nghiệm vô giá cùng hàng trăm đối tác uy
            tín
          </p>
          <form className="search-box" onSubmit={handleSearch}>
            <div className="search-item">
              <label>
                <FiMapPin className="search-icon" /> Bạn muốn đi đâu?
              </label>
              <input
                type="text"
            ...
            <div className="search-item">
              <label>
                <FiCalendar className="search-icon" /> Khởi hành
              </label>
              <input
                type="date"
                value={startDate}
            ...
            <div className="search-item">
              <label>
                <FiDollarSign className="search-icon" /> Mức giá
              </label>
              <select
                value={priceRange}
      ...
      <section className="features-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Sàn giao dịch du lịch hàng đầu dành riêng cho vùng núi phía Bắc
            </p>
          </div>
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                Hệ thống bảo mật giao dịch tuyệt đối, giữ tiền an toàn cho đến
                khi hoàn thành Tour.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                So sánh giá từ hàng trăm Đối tác du lịch để chọn ra mức giá rẻ
                nhất cho bạn.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                100% Đối tác trên sàn đều được xác minh danh tính và giấy phép
                kinh doanh.
              </p>
            </div>
            <div className="feature-card">
              ...
              <h3>Hỗ Trợ 24/7</h3>
              <p>
                Đội ngũ Admin luôn túc trực để hỗ trợ giải quyết mọi khiếu nại
                của khách hàng.
              </p>
            </div>
          </div>
      ...
      <section className="tours-section container">
        <div className="section-header">
          ...
          <p>
            Khám phá các gói Tour được yêu thích nhất từ các Đối tác của chúng
            tôi
          </p>
        </div>
      ...
      <section className="cta-section">
        ...
        <div className="cta-content container">
          ...
          <p>
            Tham gia bán hàng trên Tây Bắc Travel để tiếp cận hàng ngàn khách du
            lịch mỗi ngày với mức chiết khấu cực kỳ ưu đãi!
          </p>
