  ...
  return (
    <div className="admin-page fade-in">
      <h2 className="admin-title">
        <i className="fa-solid fa-bullhorn"></i> Quản Lý & Phát Thanh Thông Báo
      </h2>
          ...
          <form onSubmit={handleSendBroadcast}>
            <div className="broadcast-form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setBroadcast({ ...broadcast, targetRole: e.target.value })
                }
            ...
            <div className="broadcast-form-group">
              ...
              <input
                type="text"
                required
                placeholder="VD: Khuyến mãi lễ 30/4"
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setBroadcast({ ...broadcast, link: e.target.value })
                }
                className="broadcast-input"
              />
            </div>
            ...
            >
              {isSending ? (
                ...
                <>
                  <i className="fa-solid fa-paper-plane"></i> Bắn Thông Báo
                </>
              )}
            </button>
          </form>
        ...
        <div className="history-station">
          <div className="history-card">
            <h3 className="history-title">
              <i className="fa-solid fa-clock-rotate-left"></i> Lịch sử đã phát
              thanh
            </h3>
            {loading ? (
                  ...
                  <div key={index} className="history-item">
                    <div className="history-content">
                      ...
                      <div className="history-meta">
                        <span>
                          <FiUsers /> Gửi đến:{" "}
                          <strong>{item.recipientCount} người</strong>
                        </span>
                        <span className="history-meta-read">
                          <FiEye /> Đã đọc:{" "}
                          <strong>{item.readCount} người</strong>
                        </span>
                        <span>
