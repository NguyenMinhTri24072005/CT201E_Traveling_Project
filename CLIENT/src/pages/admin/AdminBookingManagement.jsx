...
export default function AdminBookingManagement() {
    ...
    useEffect(() => {
        ...
        if (selectedPartner !== 'ALL') result = result.filter(b => (b.tour?.partner || b.tour?.createdBy) === selectedPartner);
        if (searchTerm.trim() !== '') {
    ...
    return (
        <div className="admin-page fade-in">
            <div className="admin-header-container">
                <h2 className="admin-title">👑 Quản Lý Đơn Toàn Sàn</h2>
            ...
            <div className="filter-container">
                ...
                <div className="filter-item">
                    ...
                    <select className="filter-input partner-highlight" value={selectedPartner} onChange={(e) => setSelectedPartner(e.target.value)}>
