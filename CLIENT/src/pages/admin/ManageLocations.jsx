...
import './ManageLocations.css'; // 👉 Nhúng file CSS mới vào đây
...
export default function ManageLocations() {
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Bạn có chắc chắn muốn xóa điểm đến này? Các tour thuộc điểm đến này có thể bị lỗi hiển thị.")) {
    ...
    return (
        <div className="admin-page">
            <h2 className="admin-title">📍 Quản lý Điểm Đến (Location)</h2>
            
            <form onSubmit={handleSubmit} className="admin-form location-form-container">
                        ...
                        <tr key={loc._id}>
                            ...
                            <td>
                                <div className="action-buttons">
                                    <button onClick={() => handleEdit(loc)} className="btn-edit-location">
                                        ✏️ Sửa
                                    </button>
                                    <button onClick={() => handleDelete(loc._id)} className="btn-delete-location">
                                        🗑️ Xóa
                                    </button>
                                </div>
                            </td>
